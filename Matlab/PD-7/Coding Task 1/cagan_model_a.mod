...
%                           MACROECONOMÍA III
%                   Laboratorio #2 (PD#7): Coding Task 1 a)
%__________________________________________________________________________
...
irf_a = oo_.irfs;               % Las IRF se guardan en "oo_.irfs", este comando está tomando la IRF generada. 
save('irf_a.mat', 'irf_a');     % Guardamos las IRF.
