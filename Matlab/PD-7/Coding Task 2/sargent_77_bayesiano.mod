...
// "The Demand for Money during Hyperinflations under Rational Expectations" por (Sargent, 1977) usando técnicas bayesianas
...
%**************************************************************************
% 7. Estimación bayesiana
%**************************************************************************

estimated_params;

// Configuración de la estimación bayesiana 

lambda, uniform_pdf,   0.68, .5;  
alpha, uniform_pdf, -5, 2;
sigma_eta, uniform_pdf, .5, 0.25;
sigma_epsilon, uniform_pdf, .5, 0.25;
end;
